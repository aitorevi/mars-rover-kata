...
public enum PositionsToMoveForwardInTheLimit {
    NORTH(new Position(1, 2), new North(), new Position(1,0)),
    SOUTH(new Position(1, 0), new South(), new Position(1,2)),
    EAST(new Position(2, 1), new East(), new Position(0,1)),
    WEST(new Position(0, 1), new West(), new Position(2,1))
    ;
